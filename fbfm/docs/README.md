...
An extension adds **state feedback** (VA latent state from VAE-encoded images) to constrain both state and action chunk generation in a single RTC step. See [STATE_FEEDBACK_IMPLEMENTATION_EN.md](./STATE_FEEDBACK_IMPLEMENTATION_EN.md) (English) or [STATE_FEEDBACK_IMPLEMENTATION.md](./STATE_FEEDBACK_IMPLEMENTATION.md) (中文) for design and implementation details.
